...
constraints = [constraints, [sum(S1{k})==1], 
              implies( S1{k}(1), [ s1{k} == 0,        z_2-z{k} <= -1.01 ]  );
              implies( S1{k}(2), [ s1{k} == 1,        z_2-z{k} == -1 ]  );
              implies( S1{k}(3), [ s1{k} == 0,   -0.99 <= z_2-z{k} <= 0.99 ]  );
              implies( S1{k}(4), [ s1{k} == 1,         z_2-z{k} == 1 ]  );
              implies( S1{k}(5), [ s1{k} == 0,      1.01 <= z_2-z{k} ]) ]  ;   
...
constraints = [constraints, [sum(S2{k})==1], 
              ...
              implies( S2{k}(3), [ s2{k} == 0,   -0.99 <= z_3-z{k} <= 0.99 ]  );
              implies( S2{k}(4), [ s2{k} == 1,         z_3-z{k} == 1 ]  );
              implies( S2{k}(5), [ s2{k} == 0,    1.01 <= z_3-z{k} ]) ]  ;   
